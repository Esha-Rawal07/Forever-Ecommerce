...
import exchangeIcon from '../assets/assets/frontend_assets/exchange_icon.png'
import { assets } from '../assets/assets/frontend_assets/assets'

const OurPolicy = () => {
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-sm sm:text-base'> 
      <div>
